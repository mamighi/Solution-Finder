...
public partial class Edit_Problem : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (!found)
        {
            Label1.Text = "Please choose a problem to edit.";
            Label1.Visible = true;
            return;
        }
        string qu = TextBox1.Text;
        if(qu.TrimEnd().Length<1)
        {
            Label1.Text = "Please enter the question for edit.";
            Label1.Visible = true;
            return;
        }
        if(!ts.editProblem(problemID,qu))
        {
            Label1.Text = "We could not found inserted question, Please try again.";
            Label1.Visible = true;
            return;
        }
