...
public partial class _Default : Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if(!found)
        {
            Label1.Text = "Please choose a problem to continue.";
            Label1.Visible = true;
            return;
        }
        Response.Redirect("FQ.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        string req = TextBox1.Text;
        if(req.TrimEnd().Length<1)
        {
            Label2.Text = "Please Insert Your Problem";
            Label2.Visible = true;
            return;
        }
        ts.requestProblem(req);
